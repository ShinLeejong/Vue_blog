<template>
  <div class="stuffs my-5">
    ...
    <v-container class="my-5">
      <v-expansion-panels>
        <v-expansion-panel v-for="stuff in stuffs.slice(0, 6)" :key="stuff.title">
          ...
          <v-expansion-panel-content>
            ...
            <v-card flat>
              <v-card-text class="px-4 py-0 grey--text">
                <div :class="stuff.masterpiece==='걸작' ? 'blue--text' : 'red--text'">
...
export default {
  ...
  computed: {
    myStuffs() {
      return this.stuffs.filter(stuff => stuff.author === "신이종" || "Shin Leejong")
    }
  }
}
</script>